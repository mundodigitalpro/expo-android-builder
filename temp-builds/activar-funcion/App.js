...
function FlashlightApp() {
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        setHasFlashlight(isAvailable);
      } catch (error) {
        console.log('No se pudo verificar disponibilidad de linterna:', error);
  ...
  const toggleFlashlight = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Error',
        'No se pudo activar la linterna. Asegúrate de que tu dispositivo tenga linterna disponible.',
        [{ text: 'OK' }]
      );
